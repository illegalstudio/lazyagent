...
Download the desktop package for your distribution and architecture from [GitHub Releases](https://github.com/illegalstudio/lazyagent/releases) — `amd64` and `arm64` are both published:
